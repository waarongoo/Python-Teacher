...
def lesson2():
    ...
    while go == True:
        choice = input(
            "Enter 1 to move the turtle forward, 2 to move backwards, 3 to turn left, 4 to turn right, 5 to clear your drawing. 6, to stop drawing\n"
        )
        if choice == "1":
...
def startlesson1():
    print(
        'Now lets learn how to print stuff in the console. What is the console? The console is the black box that tells you stuff. How do I print stuff? Well to do that use this print("Hello World"). Here try it yourself.\n>>>'
    )
    user = input()
